...
define('REQUIRE_FIELD_ERROR', 'This field is require');
$errors = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email) {
        ...
        $errors['email'] = 'This field must be valid email addres';
    }
    if (!$password) {
        $errors['password'] = REQUIRE_FIELD_ERROR;
    }
    if (!$password_confirm) {
        $errors['password_confirm'] = REQUIRE_FIELD_ERROR;
    }
    ...
    // if (!$cv_url) {
    //     $errors['cv_url'] = REQUIRE_FIELD_ERROR;
    // }
